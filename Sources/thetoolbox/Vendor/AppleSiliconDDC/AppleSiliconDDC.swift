//  Copyright © @waydabber
//  Vendored from waydabber/AppleSiliconDDC (MIT). The only change from upstream is the
//  import block: the private IOAVService C symbols come from this target's bridging header
//  (AppleSiliconDDC-Bridging.h) instead of the upstream `AppleSiliconDDCObjC` module.
